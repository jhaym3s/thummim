            ...
            child: Column(
              ...
              children: [
                  ...
                  child: Row(
                    children: [
                      CircleAvatar(
                        ...
                        radius: 32,
                        child: CustomText(
                            text: (state is ProfileSuccessState)? state.name[0]: ".",
                            fontSize: 24.sp,
                            color: kWhite,
                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            CustomText(
                              text:  (state is ProfileSuccessState)? state.name: "...",
                ...
                const ProfileInfoTile(
                    title: "Password",
                    image: AssetsImages.password,
                    targetScreen: PasswordScreen()),
                const ProfileInfoTile(
                    title: "Notifications",
                    image: AssetsImages.blackNotification,
                ...
                SpaceY(8.dy),
                ProfileInfoTile(
                    title: "About Thummium",
                    image: AssetsImages.about,
                    targetScreen: PersonalInformationScreen()),
                ProfileInfoTile(
                    title: "Help And Support",
                    image: AssetsImages.support,
                    targetScreen: HelpAndSupportScreen()),
                Container(
    ...
    return GestureDetector(
      onTap: () {
        moveFromBottomNavBarScreen(
            context: context, targetScreen: targetScreen);
      },
      child: Padding(
